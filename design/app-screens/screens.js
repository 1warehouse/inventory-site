...
/* ---------------------------------------------------------------- fitting --
   ...
   The design is drawn for English, and SVG neither wraps nor ellipsizes. Two
   annotations in the templates keep a longer translation inside its box:
   ...
   Both are no-ops for English, where everything already fits. */
...
/* Titles centre on the artboard, so a wide action on the right has to push
   them: this hands each title the room actually left beside its action. */
function fitBar(svg) {
